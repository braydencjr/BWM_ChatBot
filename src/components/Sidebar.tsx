...
export function Sidebar({ currentView, onViewChange }: SidebarProps) {
  const navItems: NavItem[] = [
    { id: 'chat' as ViewMode, icon: MessageSquare, label: 'AI Search', subtitle: 'Search archives' },
    { id: 'archive' as ViewMode, icon: Archive, label: 'Dashboard', subtitle: 'Curator tools' },
    { id: 'settings' as ViewMode, icon: Settings, label: 'Settings', subtitle: 'Configuration' },
  ];
